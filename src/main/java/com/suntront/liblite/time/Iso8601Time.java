package com.suntront.liblite.time;
 ...
 * Description: Iso8601格式时间处理
 */
public class Iso8601Time extends DateFormat {

    public static final TimeZone UTC = TimeZone.getTimeZone("UTC");
    private static final Iso8601Time INSTANCE = new Iso8601Time();
    ...
    public synchronized Date parseObject(String source) throws ParseException {
        ...
        throw new ParseException("Iso8601Time.parseObject(String) failed", -err - 1);
    }
